...
export const platformer: GameModule = {
  ...
  mount(host: HTMLElement, services: GameServices): GameController {
    ...
    const reset = () => { paused = false; won = false; dead = false; x = 32; y = 458; vx = 0; vy = 0; stage = 1; elapsed = 0; airborne = false; };
    const jump = () => { if (!paused && !won && !dead && vy === 0) { vy = -11; airborne = true; services.sound.play('jump'); } };
